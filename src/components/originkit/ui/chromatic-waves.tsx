...
// UPDATED: Standard fallback dot colors using Rust and Cream values
const DEFAULT_COLORS = [
  "#AB1F09", // Rust / Accent
  "#C45A36", // Rust-to-Cream Transition
  "#FFF7D3", // Cream / Brand
];
...
export default function DottedBg2({
  frequency = 1,
  speed = 4,
  bgColor = "#000000", // UPDATED: Match landing page pure black background
  colors,
  cellSize = 34,
  gamma = 6,
  paletteBias = -3,
